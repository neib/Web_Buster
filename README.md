...
<b>Optional:</b></br>
&nbsp;&nbsp;--ignore-cert                               Perform 'insecure' SSL connection.</br>
&nbsp;&nbsp;-z &lt;milliseconds&gt;, --timer &lt;milliseconds&gt;   Waiting between requests.</br>
&nbsp;&nbsp;--no-check                                  Do not attempt to contact the site initially.</br>
&nbsp;&nbsp;-v, --verbose                               Verbose mode.</br>
</br>
<b>Mode sub only:</b></br>
&nbsp;&nbsp;--no-crt                                    Do not check information from crt.sh|Certificate Search.</br>
</br>
<b>Mode dir only:</b></br>
&nbsp;&nbsp;--no-slash                                  Do not add a final '/' to the directory name.</br>
</br>
<b>Examples:</b></br>
